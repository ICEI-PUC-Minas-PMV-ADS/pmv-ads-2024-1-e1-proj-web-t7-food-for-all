...
| Passos |1-Acessar o navegador. 2-Informar o endereço do site. 3-Visualizar a Home page. 4-Ir para pagina de como contribuir. 5-Realizar o Cadastro. 6-Fazer o login.7-Na tela de realização de doação, preencha os campos nescessarios e logo após clique em "Adicionar Produto".|
