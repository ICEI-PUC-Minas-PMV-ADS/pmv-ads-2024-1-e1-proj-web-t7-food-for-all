...
|:---|:---|
| Requisitos Associados |  RF-05	O sistema deve registrar a data de validade dos alimentos. RF-04 O sistema deve alterar a quantidade de alimentos doados/solicitados. RF-06	O sistema deve enviar essas informações para o banco de dados local.|
